...
The schema head is migration `0124`. The newest schema work adds campaign-level Smart Targeting tag selections, exact-capacity generations and candidate stacks, and indexes for in-flight Bundle reservations.
...
| Database order and known manifest issues | [`migrations/README.md`](../migrations/README.md) |
