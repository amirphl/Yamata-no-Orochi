-- Migration: 0011_add_new_audit_actions.sql
-- Description: Add new audit log actions to the audit_action_enum

-- UP MIGRATION
-- Add new audit actions to the enum
ALTER TYPE audit_action_enum ADD VALUE 'signup_failed';
ALTER TYPE audit_action_enum ADD VALUE 'otp_verification_failed';
ALTER TYPE audit_action_enum ADD VALUE 'otp_sms_failed';
ALTER TYPE audit_action_enum ADD VALUE 'otp_resend_failed';
ALTER TYPE audit_action_enum ADD VALUE 'otp_expired';
ALTER TYPE audit_action_enum ADD VALUE 'otp_resent';
