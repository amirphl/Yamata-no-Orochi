...
type BundleAudienceSelectionMember struct {
	...
	SelectionOrder int64     `gorm:"not null;uniqueIndex:uk_bundle_aud_sel_member_selection_order,priority:2" json:"selection_order"`
	CreatedAt      time.Time `gorm:"default:(CURRENT_TIMESTAMP AT TIME ZONE 'UTC')" json:"created_at"`
}
...
type CampaignAudienceTagAttribution struct {
	...
	SelectionOrder            int64         `gorm:"not null;uniqueIndex:uk_campaign_audience_tag_selection_order,priority:2" json:"selection_order"`
