...
def generate_random_datetimes(
    start_datetime, num_datetimes=50, num_times_per_day=7, start_hour=8, end_hour=22
):
    datetimes = []
...
if __name__ == "__main__":
    ...
    random_datetimes = generate_random_datetimes(
        start_datetime, num_datetimes=50, num_times_per_day=5
    )
